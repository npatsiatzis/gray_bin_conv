...
@CoverPoint("top.bin",xf = lambda x : x, bins = list(range(2**g_width)), at_least=1)
def number_cover(x):
    pass
...
class crv_inputs(crv.Randomized):
    def __init__(self,bin):
        ...
        self.bin = bin
        self.add_rand("bin",list(range(2**g_width)))
    ...
    def check_phase(self):
        ...
        while self.result_get_port.can_get():
            ...
            if not data_success:
                ...
                bin = data
                if(bin == gray_to_dec(int(actual_result))):
                    pass
